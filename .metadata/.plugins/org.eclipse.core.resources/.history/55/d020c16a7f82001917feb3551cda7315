...
struct command commandTable[] = {
		...
		{"setAnticoincMask",		SetAnticoincMask,		3},
		{"getAnticoincMask1",		GetAnticoincMask1,		1},
		{"getAnticoincMask2",		GetAnticoincMask2,		1},
		{"setAnticoincTiming",		SetAnticoincTiming,		3},
		{"getAnticoincLength",		GetAnticoincLength,		1},
		{"getAnticoincOffset",		GetAnticoincOffset,		1},
		{"getAnticoincReg1",		GetAnticoincReg1,		1},
		{"getAnticoincReg2",		GetAnticoincReg2,		1},
		{"setCoincMask",		SetCoincMask,		3},
		{"getCoincMaskPrompt",		GetCoincMaskPrompt,		1},

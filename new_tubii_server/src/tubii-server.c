...
struct command commandTable[] = {
		...
		{"getAnticoincMask_1",		GetAnticoincMask_1,		1},
		{"getAnticoincMask_2",		GetAnticoincMask_2,		1},
		{"setAnticoincTiming",		SetAnticoincTiming,		3},
		{"getAnticoincLength",		GetAnticoincLength,		1},
		{"getAnticoincOffset",		GetAnticoincOffset,		1},
		{"getAnticoincReg_1",		GetAnticoincReg_1,		1},
		{"getAnticoincReg_2",		GetAnticoincReg_2,		1},
